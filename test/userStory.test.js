...
User story:
As a user I want to be able to view my own profile data because I want to customize my online account for intercations with other users 

What CRUD do we need to support this user story? 

CRUD - direct work woth database
...
user can not edit other users' data 
Admin can edit any user's data

Seed file needs to make:
- At least 2 users (one to act in teh test, one to be edited upon)
- At least 1 admin 
