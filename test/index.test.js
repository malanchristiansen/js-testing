...
let messageToTest = "alex was here";

test("should be a message that repeats based in inputs", () => {
...
describe("repeatmessage error handling", () => {
  test("should throw an eror if no string is provided for the message", () => {
    expect(() => {
      repeatMessage(1, 1);
    }).toThrow();
  });
